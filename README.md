...
- **Interactive Skill Bars** — Animated progress bars for technical skills
- **Project Showcase** — Featured projects with screenshots
- **Contact Form** — Functional contact form
- **Typing Effect** — Dynamic role typing animation
...
│   ├── hero-image.png
│   ├── profile-photo.jpeg
│   ├── Muhammad_Tayyab_Sohail_CV.docx
│   ├── Certificates.pdf
│   └── projects/
│       ├── screenshot1.png
│       ├── screenshot-26.png
